...
===============================================
"""
fruits = {'Banana': '10', 'Strawberry': '35', 'Melon': '5', 'Watermalon': '15', 'Cucumber': '20'}
fruits['Kiwi'] = 50
print(fruits)
print('-------------')
"""
...
# """
grades = {"Анна": 5, "Борис": 4, "Виктор": 3, "Галина": 5, "Дмитрий": 2}
for name, price in grades.items():
    if price >= 4:
        print(name)
print('-------------')
...
===============================================
"""
countries = dict([('Malaysia', 'Kuala Lumpur'), ('Italy', 'Rome'), ('Russia', 'Moscow')])
print(countries)
...
for name, course in students:
    if course not in slovar:
        slovar[course] = []
    slovar[course].append(name)
print(slovar)
print('-------------')
"""
...
===============================================
"""
print('Задание № 5') # Выполнено после проверки ДЗ
students = {"Иван": 4, "Анна": 5, "Петр": 3, "Мария": 4}
...
"""
students = ["Анна", "Борис", "Виктор", "Галина"]
slovar = dict.fromkeys(students)
print(slovar)
slovar = dict.fromkeys(students, 20)
print(slovar)
